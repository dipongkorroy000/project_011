...
const Home = () => {
  return (
    <>
      ...
      {/* banner  */}
      <section className="w-5/6 mx-auto my-10 hero rounded-2xl max-md:h-60 h-96 bg-[url(https://i.ibb.co/BVQ40GjL/fantasy-scene-with-futuristic-human-character.jpg)]">
